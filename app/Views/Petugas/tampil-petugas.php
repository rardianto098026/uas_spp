...
<p>
    <a href="/petugas/tambah" class="btn btn-primary btn-sm"><i class="fas fa-user-plus btn-sm"></i>  Tambah Petugas </a>
    <a href="<?= site_url('petugas_export_xls') ?>" class="btn btn-success btn-sm" style="float:right;margin-right:10px"><i class="fas fa-download"></i> Export Excel</a>
    <a href="<?= site_url('petugas_export_pdf') ?>" class="btn btn-danger btn-sm" style="float:right;margin-right:10px"><i class="fas fa-download"></i> Export PDF</a>
</p>
